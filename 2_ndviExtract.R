...
build.ndvi.stack <- function(ndvi.description){
  ...
  ndvi.stack <- rast(paste("C:/Users/Administrator/Desktop/Imogen/NDVI_Imo/ndvi/",                   # edit file path as needed
...
load("RSF.RData") # edit as needed
RSF <- spTransform(RSF, CRS("+init=epsg:21036"))

setwd("C:/Users/Administrator/Desktop/Imogen/NDVI_Imo/") # edit as needed
