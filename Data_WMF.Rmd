...
rivers <- readOGR("Smithsonian_data/Data/Rivers/Rivers_reporj.shp")
```
...
```
2.3.6. Woody Vegetation

```{r}
wood <- readOGR("Smithsonian_data/Data/WoodyVegetation/Woody_N_repoj.shp")

#needs clipping by study area?

# Subset by tree or shrub cover >40%
wood <- subset(wood, WOODY_DESC != "Closed to open trees" & WOODY_DESC != "Closed to open trees (30 % polygon area)" & WOODY_DESC != "Closed to open shrubs")
